      ...
      <div className="flex flex-col sm:flex-row w-full items-center justify-around">
        ...
        >
          ...
          <p className="text-sm sm:text-base text-gray-500 leading-relaxed">
            ...
            practices, providing proven strategies, and emphasizing effective
            risk management to help our clients create lasting wealth. Through
            personalized mentorship and expert trading signals, we equip
            traders with the tools and knowledge to succeed in the dynamic forex
            market.
          </p>
        </motion.div>
      </div>
